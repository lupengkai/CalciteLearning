...
import com.tage.calcite.adapter.druid.DruidConnection;
...
/**
 * Implementation of {@link org.apache.calcite.adapter.druid.DruidConnection}.
 */
class DruidConnectionImpl implements DruidConnection {
   ...
   */
  public void request(com.tage.calcite.adapter.druid.QueryType queryType, String data, Sink sink,
   ...
   * {@code service}. */
  public Enumerable<Row> enumerable(final com.tage.calcite.adapter.druid.QueryType queryType,
